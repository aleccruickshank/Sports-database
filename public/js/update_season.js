...
let updatePlayerForm = document.getElementById('update-season-form-ajax');
...
function updateRow(data, season_id){
    ...
    for (let i = 0, row; row = table.rows[i]; i++) {
       ...
       if (table.rows[i].getAttribute("data-value") == season_id) {
            ...
            td.innerHTML = parsedData[0].season_id;
            location.reload();
       }
    }
}